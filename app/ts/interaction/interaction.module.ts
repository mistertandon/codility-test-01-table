...
import { Demo3ChildComoponent } from './demo-3-child.comoponent';
import { Demo4ChildCcomponent } from './demo-4-child.component';
...
@NgModule({
	...
	declarations: [
		...
		Demo3ChildComoponent,
		Demo4ChildCcomponent
	],
